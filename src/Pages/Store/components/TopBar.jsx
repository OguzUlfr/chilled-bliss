          ...
          {dropdownVisible &&
            <div className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-main-cream shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
              <div className="py-1 h-36 overflow-y-scroll" role="none">
                <a href="#" className="text-gray-700 block px-4 py-2 text-sm hover:text-main-red" role="menuitem" tabIndex="-1" id="menu-item-0">Şehir Seç</a>
                <a href="#" className="text-gray-700 block px-4 py-2 text-sm hover:text-main-red" role="menuitem" tabIndex="-1" id="menu-item-1">Support</a>
                <a href="#" className="text-gray-700 block px-4 py-2 text-sm hover:text-main-red" role="menuitem" tabIndex="-1" id="menu-item-2">License</a>
                <a href="#" className="text-gray-700 block px-4 py-2 text-sm hover:text-main-red" role="menuitem" tabIndex="-1" id="menu-item-2">License</a>
                <a href="#" className="text-gray-700 block px-4 py-2 text-sm hover:text-main-red" role="menuitem" tabIndex="-1" id="menu-item-2">License</a>
                <a href="#" className="text-gray-700 block px-4 py-2 text-sm hover:text-main-red" role="menuitem" tabIndex="-1" id="menu-item-2">License</a>
                <a href="#" className="text-gray-700 block px-4 py-2 text-sm hover:text-main-red" role="menuitem" tabIndex="-1" id="menu-item-2">License</a>
